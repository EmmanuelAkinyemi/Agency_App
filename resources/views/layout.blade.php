...
<body>
    <main class="container">
                    ...
                    <div class="flex w-full items-center justify-between px-4">
                        <div>
                            <button @click="navbarOpen = !navbarOpen" :class="navbarOpen && 'navbarTogglerActive'"
                                id="navbarToggler"
                                class="absolute right-4 top-1/2 block -translate-y-1/2 rounded-lg px-3 py-[6px] ring-pink-600 focus:ring-2 lg:hidden">
        ...
        <!-- ====== Navbar Section End -->
        @include('components.NotificationComponent')
                ...
                <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
                    <div class="mb-10 w-full">
                        ...
                        <div class="mb-6 flex items-center">
                            <a href="javascript:void(0)"
                                class="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-pink-600 hover:bg-pink-600 hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                ...
                <svg width="217" height="229" viewBox="0 0 217 229" fill="none"
                    ...
                    <defs>
                        <linearGradient id="paint0_linear_1179_5" x1="76.5" y1="281" x2="76.5"
                            ...
                            <stop stop-color="#d0087d" stop-opacity="0.08" />
    ...
    <script type="text/javascript">
        ...
        (function() {
            ...
            s1.async = true;
            s1.src = 'https://embed.tawk.to/6560d1f0da19b36217907ed4/1hg1385ag';
            s1.charset = 'UTF-8';
