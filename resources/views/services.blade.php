...
@section('content')
                ...
                <div class="w-full px-4 lg:w-6/12">
                    <div class="hero-content">
                        ...
                        <p class="mb-8 max-w-[480px] text-base text-body-color">
                            ...
                            profit without risk of losing capital. We are not just a trading company. MASSPROFIT is a tool
                            that allows everyone to develop potential, making investments based on our technologies.
                        </p>
    ...
    <section class="rounded-lg bg-slate-50 pt-20 mb-5 pb-12 lg:pt-[120px] lg:pb-[90px]">
        <div class="container mx-auto">
            <div class="-mx-4 flex flex-wrap">
