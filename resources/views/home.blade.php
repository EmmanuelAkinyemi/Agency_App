          ...
          <div class="-mx-4 flex flex-wrap justify-center">
            <div class="w-full px-4">
              <div class="mx-auto mb-[60px] max-w-[510px] text-center lg:mb-20">
                ...
                <p class="text-base text-body-color">
                  Here are some our seasones articles
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="-mx-4 flex flex-wrap">
            <div class="w-full px-4 md:w-1/2 lg:w-1/3">
              <div class="mx-auto mb-10 max-w-[370px]">
                ...
                <div>
                  <span
                    class="mb-5 inline-block rounded bg-pink-600 py-1 px-4 text-center text-xs font-semibold leading-loose text-white"
                  >
                    Dec 22, 2023
                  </span>
                  <h3>
                    <a
                      href="javascript:void(0)"
                      class="mb-4 inline-block text-xl font-semibold text-dark hover:text-pink-600 sm:text-2xl lg:text-xl xl:text-2xl"
                    >
