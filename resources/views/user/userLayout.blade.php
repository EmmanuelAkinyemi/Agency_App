    ...
    <section class="min-h-screen bg-gray-50" x-data="{ sideBar: false }">
        <nav class="fixed top-0 left-0 z-20 h-full pb-10 overflow-x-hidden overflow-y-auto transition origin-left transform bg-gray-900 w-60 md:translate-x-0"
            :class="{ '-translate-x-full': !sideBar, 'translate-x-0': sideBar }" @click.away="sideBar = false"> <a
                href="/" class="flex items-center px-4 py-5 mx-auto ">
                <img src="{{ asset('images/logo/icon.png') }}"
                     alt="Massprofit Logo" class="h-10 w-10" /> </a>
            <nav class="text-sm font-medium text-gray-500" aria-label="Main Navigation"> <a
                    class="flex items-center px-4 py-3 transition bg-gray-800 cursor-pointer group hover:bg-gray-800 hover:text-gray-200"
                    href="#"> <svg class="shrink-0 w-5 h-5 mr-2 text-gray-400 transition group-hover:text-gray-300"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path
                            d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" />
                    </svg> <span>Home</span> </a> <a
                    ...
                    </svg> <span>Articles</span> </a>
                    <a
                        class="flex items-center px-4 py-3 text-gray-200 transition  cursor-pointer group hover:bg-gray-800 hover:text-gray-200"
                        href="#"
                        >
                ...
                <div x-data="collapse()">
                    <div class="flex items-center justify-between px-4 py-3 transition cursor-pointer group hover:bg-gray-800 hover:text-gray-200"
                        ...
                        <div class="flex items-center"> <svg
                                ...
                                <path fill-rule="evenodd"
                                    ...
                                    clip-rule="evenodd" />
                            </svg> <span>Integrations</span> </div> <svg :class="{ 'rotate-90': open }"
                            class="shrink-0 w-4 h-4 ml-2 transition transform" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="mb-4" x-spread="collapse" x-cloak> <a
        ...
        <div class="ml-0 transition md:ml-60">
            <header class="flex items-center justify-between w-full px-4 h-14"> <button
                ...
                <div class="flex items-center"> <a href="#" class="flex text-gray-500"> <svg
                            class="shrink-0 w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                            fill="currentColor">
                            <path
                                d="M10 2a6 6 0 00-6 6v3.586l-.707.707A1 1 0 004 14h12a1 1 0 00.707-1.707L16 11.586V8a6 6 0 00-6-6zM10 18a3 3 0 01-3-3h6a3 3 0 01-3 3z" />
                        </svg> </a> <a href="#" class="ml-4 avatar avatar-sm"> <img
                            src="https://media.istockphoto.com/id/1425205946/photo/user-question-mark-sign-on-dark-background-3d-render-concept-for.webp?b=1&s=170667a&w=0&k=20&c=hhGK_KqLfjrjfGgYHlnaLCVu0yTcqo_3XbWP0xB8WHo="
