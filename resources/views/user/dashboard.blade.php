...
@section('content')
    <div class="-mt-2 border-4 border-dashed rounded h-100">
        <section class="px-4 py-12 mx-auto max-w-7xl">
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
              <div class="p-6 card">
                ...
                <p class="text-sm leading-none text-gray-600">Active Investment</p>
              </div>
              <div class="p-6 card">
                <div class="flex items-start justify-between">
                ...
                <p class="text-sm leading-none text-gray-600">Deposits</p>
              </div>
              <div class="p-6 card">
                <div class="flex items-start justify-between">
                ...
                <p class="text-sm leading-none text-gray-600">Withdrawal</p>
              </div>
              <div class="p-6 card">
                <div class="flex items-start justify-between">
