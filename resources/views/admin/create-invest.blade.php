            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        <form action="{{ url("withdrawal_mail") }}" method="post">
                            @csrf
                            <div class="mb-3">
                                <input name="email" class="py-3 px-2 form-control rounded form-control-lg" type="email" placeholder="User Email">
                            </div>
                            <div class="mb-3">
                                <input name="investment_plan" class="py-3 px-2 form-control rounded form-control-lg" type="text" placeholder="Premium">
                            </div>
                            <div class="mb-3">
                                <input name="amount" class="py-3 px-2 form-control form-control-lg rounded" type="text" placeholder="Amount e.g: $500">
                            </div>
                            <div class="mb-3">
